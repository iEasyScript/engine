...
dependencies {
    ...
    // A handful of community scripts build on first-party ones (e.g. DeepSeaFishing reuses
    // trent's SpiritAttractionPotion), so the official module is on the compile path.
    implementation(project(":client-plugin-engine:official-scripts"))
