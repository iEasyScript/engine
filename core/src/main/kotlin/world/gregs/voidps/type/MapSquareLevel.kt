...
@JvmInline
value class MapSquareLevel(val id: Int) : Coordinate3D<MapSquareLevel> {
    ...
    override fun copy(x: Int, y: Int, level: Int) = MapSquareLevel(x, y, level)
    ...
    companion object {
        ...
        val EMPTY = MapSquareLevel(0, 0, 0)
    }
}
fun MapSquareLevel.equals(x: Int = 0, y: Int = 0, level: Int = 0) = this.x == x && this.y == y && this.level == level