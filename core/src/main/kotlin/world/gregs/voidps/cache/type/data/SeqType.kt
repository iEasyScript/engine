...
data class SeqType(
...
) : CacheType, Extra, Parameterized, UnusedRecords {
    ...
    /** Excludes the final frame, whose duration holds the last pose rather than animating it. */
    val playDurationCycles: Int get() = durations?.dropLast(1)?.sum() ?: 0
